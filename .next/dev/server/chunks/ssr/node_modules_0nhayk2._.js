        ...
        switch(type){
            case 'query':
                ...
                var superEntry = entries.find(function(entry) {
                    ...
                    return limit >= req.limit && ((_a = entry.req.direction) !== null && _a !== void 0 ? _a : 'next') === reqDirection_1 && (req.values ? entry.req.values : true) && isSuperRange(entry.req.query.range, req.query.range);
                });
                return [
                    superEntry,
                    false,
...
//# sourceMappingURL=node_modules_0nhayk2._.js.map